...
#March 4, 2015
#March 18, 2015 if there is no hit in the germline, assign pseudo count 0.5
...
def bayesTeller(Dict_Bayes, testL, Dict_snv, Dict_freq_germ, Dict_freq_tumor):
	...
	for pat in testL: #test patients based on a pool of SNVs
		...
		#print Dict_snv_germ_A.get(pat)
			...
			Dict_Bayes[pat]=[math.log10((0.5+Dict_freq_tumor.get(snv, [0])[0])/(0.5+Dict_freq_germ.get(snv, [0])[0])) \
for snv in Dict_snv.get(pat)] # zero! Nonetype March 18, 2015
